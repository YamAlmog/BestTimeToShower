...
class OrefAlertsIndexer:
    ...
    def get_alerts_from_oref_api(current_date, dest_date, alerts_list):
        params = {'lang':'en',
    ...
    def arrange_alarms_within_csv(self, from_date, to_date):
        try:    
            ...
            while current_date <= target_date:
                ...
                self.get_alerts_from_oref_api(current_date, dest_date, all_time_alarams_list)
            ...
            self.get_alerts_from_oref_api(current_date, current_date + timedelta(days=day_to_add), all_time_alarams_list)
